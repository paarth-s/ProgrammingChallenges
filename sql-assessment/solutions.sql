...
/* Question 6:*/
/* FYI: My SQL operator converted the date column in the csv to varchar, and some of the floats to ints, so I had to cast them, which is shown below. If I was using a different manager, the cast portions could be removed. */
